...
import { Star, Truck, Shield, Zap, Award, ChevronLeft, Quote } from 'lucide-react'
...
const Home = () => {
  const products = [
    {
      id: 1,
      name: 'سرير كوين مخملي',
      description: 'سرير بتصميم عصري مريح جداً مع تنجيد مخملي فاخر',
      price: 18500,
      originalPrice: 22000,
      discount: 15,
      image: 'https://images.unsplash.com/photo-1505693314120-0d443867891c?q=80&w=600&h=600&auto=format&fit=crop',
      rating: 4.8,
      reviews: 142,
      stock: 5,
    },
    {
      id: 2,
      name: 'أريكة جلدية إيطالية',
      description: 'أريكة مريحة من جلد طبيعي عالي الجودة بتصميم معاصر',
      price: 32000,
      image: 'https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?q=80&w=600&h=600&auto=format&fit=crop',
      rating: 4.9,
      reviews: 89,
      stock: 3,
    },
    {
      ...
      description: 'طاولة طعام بتصميم معاصر راقي وسطح رخامي طبيعي',
      price: 26500,
      discount: 10,
      image: 'https://images.unsplash.com/photo-1604578762246-41134e37f9cc?q=80&w=600&h=600&auto=format&fit=crop',
      rating: 4.7,
      reviews: 67,
      stock: 2,
    },
    {
      id: 4,
      name: 'كرسي استرخاء قماشي',
      description: 'كرسي قراءة واسترخاء مريح بتصميم اسكندنافي حديث',
      price: 8500,
      image: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?q=80&w=600&h=600&auto=format&fit=crop',
      rating: 4.6,
      reviews: 45,
      stock: 8,
    },
