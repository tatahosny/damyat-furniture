    ...
    const fetchData = async () => {
      try {
        ...
        categoriesData.forEach(c => {
          if (c.name_en === 'Bedrooms') categoryMap[c.id] = 'bedrooms'
          else if (c.name_en === 'Living Rooms') categoryMap[c.id] = 'living-rooms'
          else if (c.name_en === 'Dining Rooms') categoryMap[c.id] = 'dining-rooms'
          else categoryMap[c.id] = 'other'
        })

        const mappedData = productsData.map(p => ({
          ...p,
          room: categoryMap[p.category_id] || 'other',
